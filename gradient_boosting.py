...
#         print('sjdqc', type(X_binned_train))
#         print(X_binned_train)
#         print('ksdj', X_binned_train.shape)
#         print('ksdj', X_binned_train.shape[0])
#         print('ksdj', X_binned_train.shape[1])
#         print('ksdj', X_binned_train.shape[2])
        ...
        self.n_iter_ = 0
#         print('ssqdqsd',X_binned_small_train.shape)
#         print('ssqdqsd',y_small_train.shape)
        while True:
            
            
            ## Subsample the features(columns)
            f_subsample_size = int(.7 * X_binned_small_train.shape[2]) #Here .7 can be replaced with an attribute of GBRegressor
            selected_features = rng.choice(
                np.arange(X_binned_small_train.shape[2]), f_subsample_size, replace=False)
            #print(selected_features)
            X_binned_small_train_f = np.asfortranarray(X_binned_small_train[:,:,selected_features])
            self.X_binned_small_train_f = X_binned_small_train_f
            X_binned_val_f = np.asfortranarray(X_binned_val[:,:,selected_features])
            self.X_binned_val = X_binned_val_f
            #################
            
            #print('tata',self.X_binned_val)
